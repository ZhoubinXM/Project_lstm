...
##########data processing###############
data_dir_1=r'E:\lstm预测\ss-lstm_0528\datadut\01'
data_dir_2=r'E:\lstm预测\ss-lstm_0528\datadut\02'
data_dir_3=r'E:\lstm预测\ss-lstm_0528\datadut\03'
data_dir_4=r'E:\lstm预测\ss-lstm_0528\datadut\04'
data_dir_5=r'E:\lstm预测\ss-lstm_0528\datadut\05'
data_dir_6=r'E:\lstm预测\ss-lstm_0528\datadut\06'
data_dir_7=r'E:\lstm预测\ss-lstm_0528\datadut\07'
data_dir_8=r'E:\lstm预测\ss-lstm_0528\datadut\08'
data_dir_9=r'E:\lstm预测\ss-lstm_0528\datadut\09'
data_dir_10=r'E:\lstm预测\ss-lstm_0528\datadut\10'
...
#车辆影响数据
gruop_grid_veh2ped_1=veh2ped_circle_group_model_input(obs_1, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_1,veh_data_1,circle_map_weights)#圆形区域，若要矩形区域改成veh2ped_grid_model_input
gruop_grid_veh2ped_2=veh2ped_circle_group_model_input(obs_2, observed_frame_num, dimensions_2, veh_neighborhood_size,grid_radius, grid_angle,raw_data_2,veh_data_2,circle_map_weights)#若要改成log或者矩形最好换个名字=。=
gruop_grid_veh2ped_3=veh2ped_circle_group_model_input(obs_3, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_3,veh_data_3,circle_map_weights)
gruop_grid_veh2ped_4=veh2ped_circle_group_model_input(obs_4, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_4,veh_data_4,circle_map_weights)
gruop_grid_veh2ped_5=veh2ped_circle_group_model_input(obs_5, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_5,veh_data_5,circle_map_weights)
gruop_grid_veh2ped_6=veh2ped_circle_group_model_input(obs_6, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_6,veh_data_6,circle_map_weights)
gruop_grid_veh2ped_7=veh2ped_circle_group_model_input(obs_7, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_7,veh_data_7,circle_map_weights)
gruop_grid_veh2ped_8=veh2ped_circle_group_model_input(obs_8, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_8,veh_data_8,circle_map_weights)
gruop_grid_veh2ped_9=veh2ped_circle_group_model_input(obs_9, observed_frame_num, dimensions_1, veh_neighborhood_size,grid_radius, grid_angle,raw_data_9,veh_data_9,circle_map_weights)
...
#    scene_input = np.concatenate((img_1, img_2, img_3, img_4))
    ...
    for i in range (len(test_output)):
        plt.plot(predict_output[i][:, 0], predict_output[i][:, 1], "y+", label='predicted_SS_LSTM')
        plt.plot(test_output[i][:, 0], test_output[i][:, 1], "g+", label='test_SS_LSTM')
    plt.title(i)
    plt.legend()
    plt.show()
