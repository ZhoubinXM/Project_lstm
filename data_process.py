...
class DataProcesser:
    ...
    def __init__(self, data_dir, observed_frame_num, predicting_frame_num): # ,dup_threshold):
        ...
        self.file_path = os.path.join(self.data_dir, 'roundabout_traj_ped_filtered.csv')
    ...
    def from_csv(self):
        ...
        self.raw_data = (self.raw_data[4, 1:], self.raw_data[1, 1:], self.raw_data[7, 1:], self.raw_data[6,1:])
